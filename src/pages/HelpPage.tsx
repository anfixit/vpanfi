...
function Troubleshooting({ platform }: { platform: Platform }) {
  return (
    ...
    >
      ...
      <details className="help-detail">
        <summary>Звонки в Telegram прерываются или голос дрожит</summary>
        <p>
          Для звонков выбирайте вариант с 🌐 «лучше с мобильного»: он передаёт
          голос ровнее, чем 🛜. Перед звонком переключитесь на 🌐 в той же
          стране и подключитесь заново. Если голос всё равно рвётся,
          попробуйте другую страну и сравните Wi-Fi с мобильным интернетом.
        </p>
      </details>
      <details className="help-detail">
        <summary>
