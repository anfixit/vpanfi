...
apply_panel_credentials() {
  ...
  set_env_value VPANFI_REMNAWAVE_SQUAD_UUID "${VPANFI_REMNAWAVE_SQUAD_UUID:-}"
  set_env_value VPANFI_TELEGRAM_ALERT_BOT_TOKEN "${VPANFI_TELEGRAM_ALERT_BOT_TOKEN:-}"
  ...
  set_env_value VPANFI_SMTP_PASSWORD "${VPANFI_SMTP_PASSWORD:-}"
  set_env_value VPANFI_SMTP_FROM_EMAIL "${VPANFI_SMTP_FROM_EMAIL:-}"
  set_env_value VPANFI_SMTP_FROM_NAME "${VPANFI_SMTP_FROM_NAME:-}"
